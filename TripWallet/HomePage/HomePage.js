// 1. המערך הבסיסי (Hardcoded) שתמיד קיים
const tripsDB = [
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 2. בדיקה האם הגיע טיול חדש דרך ה-URL
